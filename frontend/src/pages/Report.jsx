...
const DiabetesReport = () => {
  ...
  return (
    <>
    <div className={`${result?.prediction == 1?"bg-red-600":"bg-green-600"} shadow-sm rounded-xl flex flex-col gap-4 p-8`}>
        <div className="flex text-lg gap-8 max-lg:gap-2 items-center max-lg:grid-cols-1 max-lg:grid">
          <h1 className="text-2xl font-bold text-white">
            Prediction : {result?.prediction == 1?"Potentially at Risk":"Not at Risk"}
          </h1>
        </div>
      </div>
